...
document.addEventListener('DOMContentLoaded', function () {
    ...
    electronics_retail_shop_button.addEventListener('click', function (e) {
        ...
        electronics_retail_shop_checkData.append('action', 'check_plugin_activation');
        ...
        .then(res => {
            if (res.success && res.data.active) {
                ...
                electronics_retail_shop_installData.append('action', 'install_and_activate_required_plugin');
                electronics_retail_shop_installData.append('_ajax_nonce', installPluginData.nonce);
